...
@section('content')
    ...
    <div class="container"
        ...
        <div class="row">
            @include('layouts.left_menu_picture')
            <div class="col-sm-10 col-md-8" itemscope="" itemtype="" style="balllckground-color: #ffffff;">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/film/{{$film->film_id}}/picture/">Все фото</a></li>
                    <li class="active"><h2>Постеры</h2></li>
                </ul>
                <h1>{{$film->film_name}} (<a
                ...
                <h3>Постеры</h3>
                <div class="row">
                    <div class="col-sm-3"><b>Фотографий:</b> {{$pictures->count()}} </div>
                ...
                <div class="picture-list" id="picture-list">
                    <div class="row">
                        @foreach ($pictures as $picture)
                            <div class="col-sm-3" style="width: 20%;"><a href="picture/{{$picture->picture_id}}/"><img
                                        class="img-rounded img-responsive center-block"
                                        src="/storage/{{$picture->picture_link}}"
                                        alt=""></a>&nbsp;<b><a href="picture/{{$picture->picture_id}}/">{{$film->film_name}} - {{$picture->picture_type_name}}</a></b><br><small>&nbsp;<i class="icon-eye-open"></i> 60 -
                                    просмотров</small><br><br></div>
                        @endforeach
                    </div>
                    <div class="row"></div>
                </div>
